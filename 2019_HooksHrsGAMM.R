...
dat <- read.csv("2019effort_5X5.csv") #AIS data at 5x5 res

#aggregate hook data and rename
hookdat = with(datMaster2,aggregate(hooks2, by = list(lon,lat, fleet), sum))
