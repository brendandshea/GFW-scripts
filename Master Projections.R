...
colnames(haw_ams)[1] <- "Fishery"
colnames(haw_ams)[2] <- "Trip_ID"
colnames(haw_ams)[3] <- "Vessel_ID"
colnames(haw_ams)[4] <- "Lat"
colnames(haw_ams)[5] <- "Long"
colnames(haw_ams)[6] <- "Year"
colnames(haw_ams)[7] <- "Hooks"
colnames(haw_ams)[8] <- "Log Hooks"
colnames(haw_ams)[9] <- "CPUE.Blueshark"
colnames(haw_ams)[10] <- "SE.Blueshark"
colnames(haw_ams)[11] <- "CPUE.Silky"
colnames(haw_ams)[12] <- "SE.Silky"
colnames(haw_ams)[13] <- "CPUE.Shortfinmako"
colnames(haw_ams)[14] <- "SE.Shortfinmako"
colnames(haw_ams)[15] <- "CPUE.longfinmako"
colnames(haw_ams)[16] <- "SE.longfinmako"
...
cook_haw_ams_cpues <- data.frame("Country" = "Cook Islands",
                                 "Source" = "haw_ams",
                                 "Species" = c("Blue Shark", "Silky Shark", "Shortfin Mako", "Longfin Mako")
