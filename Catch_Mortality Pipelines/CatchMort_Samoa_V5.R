...
{start.time <- Sys.time()
  ...
  samoa_bsh_proj$catch.upr <- quantile(samoa_bsh_total_catches, 0.95)
  samoa_bsh_proj$catch.lwr <- quantile(samoa_bsh_total_catches, 0.05)
  
  samoa_bsh_total_DOA <- colSums(samoa_bsh_DOA)
  samoa_bsh_proj$DOA <- mean(samoa_bsh_total_DOA)
  samoa_bsh_proj$DOA.upr <- quantile(samoa_bsh_total_DOA, 0.95)
  samoa_bsh_proj$DOA.lwr <- quantile(samoa_bsh_total_DOA, 0.05)
  
  samoa_bsh_total_PRM <- colSums(samoa_bsh_PRM)
  samoa_bsh_proj$PRM <- mean(samoa_bsh_total_PRM)
  samoa_bsh_proj$PRM.upr <- quantile(samoa_bsh_total_PRM, 0.95)
  samoa_bsh_proj$PRM.lwr <- quantile(samoa_bsh_total_PRM, 0.05)
  
  samoa_bsh_total_total <- colSums(samoa_bsh_total)
  samoa_bsh_proj$total <- mean(samoa_bsh_total_total)
  samoa_bsh_proj$total.upr <- quantile(samoa_bsh_total_total, 0.95)
  samoa_bsh_proj$total.lwr <- quantile(samoa_bsh_total_total, 0.05)
  ...
  samoa_silky_proj$catch.upr <- quantile(samoa_silky_total_catches, 0.95)
  samoa_silky_proj$catch.lwr <- quantile(samoa_silky_total_catches, 0.05)
  
  samoa_silky_total_DOA <- colSums(samoa_silky_DOA)
  samoa_silky_proj$DOA <- mean(samoa_silky_total_DOA)
  samoa_silky_proj$DOA.upr <- quantile(samoa_silky_total_DOA, 0.95)
  samoa_silky_proj$DOA.lwr <- quantile(samoa_silky_total_DOA, 0.05)
  
  samoa_silky_total_PRM <- colSums(samoa_silky_PRM)
  samoa_silky_proj$PRM <- mean(samoa_silky_total_PRM)
  samoa_silky_proj$PRM.upr <- quantile(samoa_silky_total_PRM, 0.95)
  samoa_silky_proj$PRM.lwr <- quantile(samoa_silky_total_PRM, 0.05)
  
  samoa_silky_total_total <- colSums(samoa_silky_total)
  samoa_silky_proj$total <- mean(samoa_silky_total_total)
  samoa_silky_proj$total.upr <- quantile(samoa_silky_total_total, 0.95)
  samoa_silky_proj$total.lwr <- quantile(samoa_silky_total_total, 0.05)
  ...
  samoa_thresher_proj$catch.upr <- quantile(samoa_thresher_total_catches, 0.95)
  samoa_thresher_proj$catch.lwr <- quantile(samoa_thresher_total_catches, 0.05)
  
  samoa_thresher_total_DOA <- colSums(samoa_thresher_DOA)
  samoa_thresher_proj$DOA <- mean(samoa_thresher_total_DOA)
  samoa_thresher_proj$DOA.upr <- quantile(samoa_thresher_total_DOA, 0.95)
  samoa_thresher_proj$DOA.lwr <- quantile(samoa_thresher_total_DOA, 0.05)
  
  samoa_thresher_total_PRM <- colSums(samoa_thresher_PRM)
  samoa_thresher_proj$PRM <- mean(samoa_thresher_total_PRM)
  samoa_thresher_proj$PRM.upr <- quantile(samoa_thresher_total_PRM, 0.95)
  samoa_thresher_proj$PRM.lwr <- quantile(samoa_thresher_total_PRM, 0.05)
  
  samoa_thresher_total_total <- colSums(samoa_thresher_total)
  samoa_thresher_proj$total <- mean(samoa_thresher_total_total)
  samoa_thresher_proj$total.upr <- quantile(samoa_thresher_total_total, 0.95)
  samoa_thresher_proj$total.lwr <- quantile(samoa_thresher_total_total, 0.05)
  ...
  #run averages
  samoa_mako_proj <- data.frame("Species" = "Mako Shark",
                                   "catch" = NA,
                                   "catch.upr" = NA,
                                   "catch.lwr" = NA,
                                   "DOA" = NA,
  ...
  samoa_mako_proj$catch.upr <- quantile(samoa_mako_total_catches, 0.95)
  samoa_mako_proj$catch.lwr <- quantile(samoa_mako_total_catches, 0.05)
  
  samoa_mako_total_DOA <- colSums(samoa_mako_DOA)
  samoa_mako_proj$DOA <- mean(samoa_mako_total_DOA)
  samoa_mako_proj$DOA.upr <- quantile(samoa_mako_total_DOA, 0.95)
  samoa_mako_proj$DOA.lwr <- quantile(samoa_mako_total_DOA, 0.05)
  
  samoa_mako_total_PRM <- colSums(samoa_mako_PRM)
  samoa_mako_proj$PRM <- mean(samoa_mako_total_PRM)
  samoa_mako_proj$PRM.upr <- quantile(samoa_mako_total_PRM, 0.95)
  samoa_mako_proj$PRM.lwr <- quantile(samoa_mako_total_PRM, 0.05)
  
  samoa_mako_total_total <- colSums(samoa_mako_total)
  samoa_mako_proj$total <- mean(samoa_mako_total_total)
  samoa_mako_proj$total.upr <- quantile(samoa_mako_total_total, 0.95)
  samoa_mako_proj$total.lwr <- quantile(samoa_mako_total_total, 0.05)
  ...
  samoa_oceanicwhitetip_proj$catch.upr <- quantile(samoa_oceanicwhitetip_total_catches, 0.95)
  samoa_oceanicwhitetip_proj$catch.lwr <- quantile(samoa_oceanicwhitetip_total_catches, 0.05)
  ...
  samoa_oceanicwhitetip_proj$DOA.upr <- quantile(samoa_oceanicwhitetip_total_DOA, 0.95)
  samoa_oceanicwhitetip_proj$DOA.lwr <- quantile(samoa_oceanicwhitetip_total_DOA, 0.05)
  ...
  samoa_oceanicwhitetip_proj$PRM.upr <- quantile(samoa_oceanicwhitetip_total_PRM, 0.95)
  samoa_oceanicwhitetip_proj$PRM.lwr <- quantile(samoa_oceanicwhitetip_total_PRM, 0.05)
  ...
  samoa_oceanicwhitetip_proj$total.upr <- quantile(samoa_oceanicwhitetip_total_total, 0.95)
  samoa_oceanicwhitetip_proj$total.lwr <- quantile(samoa_oceanicwhitetip_total_total, 0.05)
  ...
  samoa_hammerhead_proj$catch.upr <- quantile(samoa_hammerhead_total_catches, 0.95)
  samoa_hammerhead_proj$catch.lwr <- quantile(samoa_hammerhead_total_catches, 0.05)
  
  samoa_hammerhead_total_DOA <- colSums(samoa_hammerhead_DOA)
  samoa_hammerhead_proj$DOA <- mean(samoa_hammerhead_total_DOA)
  samoa_hammerhead_proj$DOA.upr <- quantile(samoa_hammerhead_total_DOA, 0.95)
  samoa_hammerhead_proj$DOA.lwr <- quantile(samoa_hammerhead_total_DOA, 0.05)
  
  samoa_hammerhead_total_PRM <- colSums(samoa_hammerhead_PRM)
  samoa_hammerhead_proj$PRM <- mean(samoa_hammerhead_total_PRM)
  samoa_hammerhead_proj$PRM.upr <- quantile(samoa_hammerhead_total_PRM, 0.95)
  samoa_hammerhead_proj$PRM.lwr <- quantile(samoa_hammerhead_total_PRM, 0.05)
  
  samoa_hammerhead_total_total <- colSums(samoa_hammerhead_total)
  samoa_hammerhead_proj$total <- mean(samoa_hammerhead_total_total)
  samoa_hammerhead_proj$total.upr <- quantile(samoa_hammerhead_total_total, 0.95)
  samoa_hammerhead_proj$total.lwr <- quantile(samoa_hammerhead_total_total, 0.05)
  ...
  samoa_othersharks_proj$catch.upr <- quantile(samoa_othersharks_total_catches, 0.95)
  samoa_othersharks_proj$catch.lwr <- quantile(samoa_othersharks_total_catches, 0.05)
  
  samoa_othersharks_total_DOA <- colSums(samoa_othersharks_DOA)
  samoa_othersharks_proj$DOA <- mean(samoa_othersharks_total_DOA)
  samoa_othersharks_proj$DOA.upr <- quantile(samoa_othersharks_total_DOA, 0.95)
  samoa_othersharks_proj$DOA.lwr <- quantile(samoa_othersharks_total_DOA, 0.05)
  
  samoa_othersharks_total_PRM <- colSums(samoa_othersharks_PRM)
  samoa_othersharks_proj$PRM <- mean(samoa_othersharks_total_PRM)
  samoa_othersharks_proj$PRM.upr <- quantile(samoa_othersharks_total_PRM, 0.95)
  samoa_othersharks_proj$PRM.lwr <- quantile(samoa_othersharks_total_PRM, 0.05)
  ...
  samoa_othersharks_proj$total.upr <- quantile(samoa_othersharks_total_total, 0.95)
  samoa_othersharks_proj$total.lwr <- quantile(samoa_othersharks_total_total, 0.05)
