...
{start.time <- Sys.time()
  ...
  newcaledonia_silky_proj$total.sd <- sd(newcaledonia_silky_total_total)
  ...
  newcaledonia_thresher_proj$catch.sd <-sd(newcaledonia_thresher_total_catches)
  ...
  newcaledonia_thresher_proj$DOA.sd <- sd(newcaledonia_thresher_total_DOA)
  ...
  newcaledonia_thresher_proj$PRM.sd <- sd(newcaledonia_thresher_total_PRM)
  ...
  newcaledonia_thresher_proj$total.sd <- sd(newcaledonia_thresher_total_total)
  ...
  #run averages
  newcaledonia_mako_proj <- data.frame("Species" = "Mako",
                                "catch" = NA,
                                "catch.sd" = NA,
                                "DOA" = NA,
                                "DOA.sd" = NA,
  ...
  newcaledonia_mako_proj$total.sd <- sd(newcaledonia_mako_total_total)
  ...
  newcaledonia_oceanicwhitetip_proj$catch.sd <-sd(newcaledonia_oceanicwhitetip_total_catches)
  ...
  newcaledonia_oceanicwhitetip_proj$DOA.sd <- sd(newcaledonia_oceanicwhitetip_total_DOA)
  ...
  newcaledonia_oceanicwhitetip_proj$PRM.sd <- sd(newcaledonia_oceanicwhitetip_total_PRM)
  ...
  newcaledonia_oceanicwhitetip_proj$total.sd <- sd(newcaledonia_oceanicwhitetip_total_total)
  ...
  newcaledonia_hammerhead_proj$catch.sd <-sd(newcaledonia_hammerhead_total_catches)
  ...
  newcaledonia_hammerhead_proj$DOA.sd <- sd(newcaledonia_hammerhead_total_DOA)
  ...
  newcaledonia_hammerhead_proj$PRM.sd <- sd(newcaledonia_hammerhead_total_PRM)
  ...
  newcaledonia_hammerhead_proj$total.sd <- sd(newcaledonia_hammerhead_total_total)
  ...
  newcaledonia_othersharks_proj$catch.sd <-sd(newcaledonia_othersharks_total_catches)
  ...
  newcaledonia_othersharks_proj$DOA.sd <- sd(newcaledonia_othersharks_total_DOA)
  ...
  newcaledonia_othersharks_proj$PRM.sd <- sd(newcaledonia_othersharks_total_PRM)
  ...
  newcaledonia_othersharks_proj$total.sd <- sd(newcaledonia_othersharks_total_total)
