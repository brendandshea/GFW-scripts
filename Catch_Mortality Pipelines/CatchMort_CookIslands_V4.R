...
cookislands_silky_proj$total.sd <- sd(cookislands_silky_total_total)
...
cookislands_thresher_proj$catch.sd <-sd(cookislands_thresher_total_catches)
...
cookislands_thresher_proj$DOA.sd <- sd(cookislands_thresher_total_DOA)
...
cookislands_thresher_proj$PRM.sd <- sd(cookislands_thresher_total_PRM)
...
cookislands_thresher_proj$total.sd <- sd(cookislands_thresher_total_total)
...
#run averages
cookislands_mako_proj <- data.frame("Species" = "Mako",
                                 "catch" = NA,
                                "catch.sd" = NA,
                                "DOA" = NA,
                                "DOA.sd" = NA,
...
cookislands_oceanicwhitetip_proj$catch.sd <-sd(cookislands_oceanicwhitetip_total_catches)
...
cookislands_oceanicwhitetip_proj$DOA.sd <- sd(cookislands_oceanicwhitetip_total_DOA)
...
cookislands_oceanicwhitetip_proj$PRM.sd <- sd(cookislands_oceanicwhitetip_total_PRM)
...
cookislands_oceanicwhitetip_proj$total.sd <- sd(cookislands_oceanicwhitetip_total_total)
...
cookislands_hammerhead_proj$catch.sd <-sd(cookislands_hammerhead_total_catches)
...
cookislands_hammerhead_proj$DOA.sd <- sd(cookislands_hammerhead_total_DOA)
...
cookislands_hammerhead_proj$PRM.sd <- sd(cookislands_hammerhead_total_PRM)
...
cookislands_hammerhead_proj$total.sd <- sd(cookislands_hammerhead_total_total)
...
cookislands_othersharks_proj$catch.sd <-sd(cookislands_othersharks_total_catches)
...
cookislands_othersharks_proj$DOA.sd <- sd(cookislands_othersharks_total_DOA)
...
cookislands_othersharks_proj$PRM.sd <- sd(cookislands_othersharks_total_PRM)
...
cookislands_othersharks_proj$total.sd <- sd(cookislands_othersharks_total_total)
