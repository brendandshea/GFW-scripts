...
for (j in 1:n) {
  for (i in 1:1000) {
    ...
    newcaledonia_bsh_DOA[j,i] <- newcaledonia_bsh_catches[j,i] * bsh_cm[i] 
    newcaledonia_bsh_released[j,i] <- newcaledonia_bsh_catches[j,i] - newcaledonia_bsh_DOA[j,i]
    newcaledonia_bsh_PRM[j,i] <- newcaledonia_bsh_released[j,i] * bsh_prm[i] 
...
for (j in 1:n) {
  for (i in 1:1000) {
    ...
    newcaledonia_silky_DOA[j,i] <- newcaledonia_silky_catches[j,i] * silky_cm[i] 
    newcaledonia_silky_released[j,i] <- newcaledonia_silky_catches[j,i] - newcaledonia_silky_DOA[j,i]
    newcaledonia_silky_PRM[j,i] <- newcaledonia_silky_released[j,i] * silky_prm[i] 
...
for (j in 1:n) {
  for (i in 1:1000) {
    ...
    newcaledonia_thresher_DOA[j,i] <- newcaledonia_thresher_catches[j,i] * thresher_cm[i] 
    newcaledonia_thresher_released[j,i] <- newcaledonia_thresher_catches[j,i] - newcaledonia_thresher_DOA[j,i]
    newcaledonia_thresher_PRM[j,i] <- newcaledonia_thresher_released[j,i] * thresher_prm[i] 
...
for (j in 1:n) {
  for (i in 1:1000) {
    ...
    newcaledonia_mako_DOA[j,i] <- newcaledonia_mako_catches[j,i] * mako_cm[i] 
    newcaledonia_mako_released[j,i] <- newcaledonia_mako_catches[j,i] - newcaledonia_mako_DOA[j,i]
    newcaledonia_mako_PRM[j,i] <- newcaledonia_mako_released[j,i] * mako_prm[i] 
...
for (j in 1:n) {
  for (i in 1:1000) {
    ...
    newcaledonia_oceanicwhitetip_DOA[j,i] <- newcaledonia_oceanicwhitetip_catches[j,i] * oceanicwhitetip_cm[i] 
    newcaledonia_oceanicwhitetip_released[j,i] <- newcaledonia_oceanicwhitetip_catches[j,i] - newcaledonia_oceanicwhitetip_DOA[j,i]
    newcaledonia_oceanicwhitetip_PRM[j,i] <- newcaledonia_oceanicwhitetip_released[j,i] * oceanicwhitetip_prm[i] 
...
for (j in 1:n) {
  for (i in 1:1000) {
    ...
    newcaledonia_hammerhead_DOA[j,i] <- newcaledonia_hammerhead_catches[j,i] * hammerhead_cm[i] 
    newcaledonia_hammerhead_released[j,i] <- newcaledonia_hammerhead_catches[j,i] - newcaledonia_hammerhead_DOA[j,i]
    newcaledonia_hammerhead_PRM[j,i] <- newcaledonia_hammerhead_released[j,i] * hammerhead_prm[i] 
...
for (j in 1:n) {
  for (i in 1:1000) {
    ...
    newcaledonia_othersharks_DOA[j,i] <- newcaledonia_othersharks_catches[j,i] * othersharks_cm[i] 
    newcaledonia_othersharks_released[j,i] <- newcaledonia_othersharks_catches[j,i] - newcaledonia_othersharks_DOA[j,i]
    newcaledonia_othersharks_PRM[j,i] <- newcaledonia_othersharks_released[j,i] * othersharks_prm[i] 
