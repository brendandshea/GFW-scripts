...
for (j in 1:n) {
  for (i in 1:1000) {
    ...
    samoa_bsh_DOA[j,i] <- samoa_bsh_catches[j,i] * bsh_cm[i] 
    samoa_bsh_released[j,i] <- samoa_bsh_catches[j,i] - samoa_bsh_DOA[j,i]
    samoa_bsh_PRM[j,i] <- samoa_bsh_released[j,i] * bsh_prm[i] 
...
for (j in 1:n) {
  for (i in 1:1000) {
    ...
    samoa_silky_DOA[j,i] <- samoa_silky_catches[j,i] * silky_cm[i] 
    samoa_silky_released[j,i] <- samoa_silky_catches[j,i] - samoa_silky_DOA[j,i]
    samoa_silky_PRM[j,i] <- samoa_silky_released[j,i] * silky_prm[i] 
...
for (j in 1:n) {
  for (i in 1:1000) {
    ...
    samoa_thresher_DOA[j,i] <- samoa_thresher_catches[j,i] * thresher_cm[i] 
    samoa_thresher_released[j,i] <- samoa_thresher_catches[j,i] - samoa_thresher_DOA[j,i]
    samoa_thresher_PRM[j,i] <- samoa_thresher_released[j,i] * thresher_prm[i] 
...
for (j in 1:n) {
  for (i in 1:1000) {
    ...
    samoa_mako_DOA[j,i] <- samoa_mako_catches[j,i] * mako_cm[i] 
    samoa_mako_released[j,i] <- samoa_mako_catches[j,i] - samoa_mako_DOA[j,i]
    samoa_mako_PRM[j,i] <- samoa_mako_released[j,i] * mako_prm[i] 
...
for (j in 1:n) {
  for (i in 1:1000) {
    ...
    samoa_oceanicwhitetip_DOA[j,i] <- samoa_oceanicwhitetip_catches[j,i] * oceanicwhitetip_cm[i] 
    samoa_oceanicwhitetip_released[j,i] <- samoa_oceanicwhitetip_catches[j,i] - samoa_oceanicwhitetip_DOA[j,i]
    samoa_oceanicwhitetip_PRM[j,i] <- samoa_oceanicwhitetip_released[j,i] * oceanicwhitetip_prm[i] 
...
for (j in 1:n) {
  for (i in 1:1000) {
    ...
    samoa_hammerhead_DOA[j,i] <- samoa_hammerhead_catches[j,i] * hammerhead_cm[i] 
    samoa_hammerhead_released[j,i] <- samoa_hammerhead_catches[j,i] - samoa_hammerhead_DOA[j,i]
    samoa_hammerhead_PRM[j,i] <- samoa_hammerhead_released[j,i] * hammerhead_prm[i] 
...
for (j in 1:n) {
  for (i in 1:1000) {
    ...
    samoa_othersharks_DOA[j,i] <- samoa_othersharks_catches[j,i] * othersharks_cm[i] 
    samoa_othersharks_released[j,i] <- samoa_othersharks_catches[j,i] - samoa_othersharks_DOA[j,i]
    samoa_othersharks_PRM[j,i] <- samoa_othersharks_released[j,i] * othersharks_prm[i] 
